...
class Game():
      ...
      def draw(self):
        ...
        info_text = content_font.render('Selecione', True, WHITE)
        ...
        if not self.level == 5:
            next_text = content_font.render('Nivel completo, pressione espaço para o próximo nível', True, WHITE)
        else:
            next_text = content_font.render('Parabens, você venceu! Pressione espaço para jogar novamente', True, WHITE)
